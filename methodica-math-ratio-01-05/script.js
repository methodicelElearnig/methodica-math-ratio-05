...
/* =========================================================
   ...
   שקף 55. דמות-נלווית לפי הדמות שנבחרה קודם בפרויקט — אין וידאו
   "רמה עלתה!" ייעודי בנכסים, נבחרו הפוזות הכי-קרובות מבחינה תוכנית
   שכבר קיימות בתיקייה (חשיבה/שאילה), אותה מוסכמה בדיוק כמו סיינים
   1+4 של הפרויקט הזה — שיוך זה טרם אושר מול המפיקה.
   ========================================================= */
...
const VIQ_CFG_S2 = {
  inputs: ['s2-cd', 's2-db'], correct: [12, 4], checkBtn: 's2-check', feedbox: 's2-feedbox', nextScreen: null,
